...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="font-h1 text-h1 text-on-surface">Tambah Kategori Baru</h1>
        <p class="font-body-sm text-body-sm text-outline mt-1">Gunakan warna biar kategori gampang dikenali</p>
    </div>
    ...
    <div class="bg-surface-container-lowest rounded-xl border border-surface-variant shadow-sm p-6 md:p-8">
        ...
        <form action="{{ route('categories.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input id="color" name="color" type="color" value="{{ old('color', '#2196F3') }}"
