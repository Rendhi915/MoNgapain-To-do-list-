...
<main class="min-h-screen flex items-center justify-center p-4 lg:p-6">
    <div class="w-full max-w-md bg-white/70 backdrop-blur-xl rounded-2xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)]
        ...
        <div class="text-center flex flex-col items-center gap-2">
            ...
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight mt-2">Selamat datang</h1>
            <p class="text-sm text-slate-500 mt-1">Masukkan akunmu untuk lanjut mengatur aktivitas.</p>
        </div>
        ...
        <form action="/login" method="POST" class="flex flex-col gap-4">
            ...
            <div class="flex items-center gap-2 mt-1">
                <input class="w-4 h-4 rounded border-slate-300 text-indigo-600 focus:ring-indigo-600 cursor-pointer"
